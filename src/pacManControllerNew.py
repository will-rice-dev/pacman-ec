...
"""
class IndividualPacManControllerNew:
    ...
    """
    This overwrites the "IndividualPacManControllerNew + IndividualPacManControllerNew" to form
        two offspring of type IndividualPacManControllerNew from two parents.
    ...
    def __add__(self, other):
        ...
        baby1 = IndividualPacManControllerNew(self.config, False, baby1Tree)
        baby2 = IndividualPacManControllerNew(self.config, False, baby2Tree)
        return baby1, baby2
    ...
    def mutate(self):
        ...
        mutation = IndividualPacManControllerNew(self.config, False, treeList)
        return mutation

    # Returns the amount that the score from the game needs to be adjusted by.
    def parsimony(self):
        overage = self.config["nodeThreshold"] - self.nodeCount # Only punishes over a certain threshold.
        punishment = 0
        if overage < 0:
            punishment = overage * self.config["parsimony"]
        return punishment

    # Sets the score based on whether this controller has been played or not.
