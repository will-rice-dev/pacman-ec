...
"""
class IndividualGhostController:
    ...
    """
    This overwrites the "IndividualGhostController + IndividualGhostController" to form
        two offspring of type IndividualGhostController from two parents.
    ...
    def __add__(self, other):
        ...
        baby1 = IndividualGhostController(self.config, False, baby1Tree)
        baby2 = IndividualGhostController(self.config, False, baby2Tree)
        return baby1, baby2
    ...
    def mutate(self):
        ...
        mutation = IndividualGhostController(self.config, False, treeList)
        return mutation
    ...
    def parsimony(self):
        ...
        punishment = 0
        if overage < 0:
            punishment = overage * self.config["parsimonyGhost"]
        return punishment
