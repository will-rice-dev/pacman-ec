...
class Game:
    ...
    def getNextPac(self, pacNeighbors):
        ...
        for neighbor in pacNeighbors:
            ...
            neighborFitness = self.pacFitnessEval(G, P, W, F)
    ...
    def pacFitnessEval(self, G, P, W, F):
        gWeight = G * self.controller[0]
        pWeight = P * self.controller[1]
        wWeight = W * self.controller[2]
        fWeight = F * self.controller[3]

        return gWeight + pWeight + wWeight + fWeight
